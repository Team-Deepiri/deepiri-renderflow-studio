...
fn main() {
    tauri::Builder::default()
        .invoke_handler(tauri::generate_handler![
            ...
            commands::orchestrator::orchestrator_list_projects_paginated,
            commands::orchestrator::orchestrator_create_project,
            commands::orchestrator::orchestrator_get_project,
